...
namespace Blacklite.Framework.Steps
{
    ...
    {
        IEnumerable<IStepDescriptor<TReturn>> GetStepsForContext<T>(T context);
        IEnumerable<IStepDescriptor<TReturn>> GetStepsForContextType(Type type);
    }
    ...
    class StepContainer<TReturn> : IStepContainer<TReturn>
    {
        ...
        public IEnumerable<IStepDescriptor<TReturn>> GetStepsForContext<T>(T context) => GetStepsForContextType(context?.GetType() ?? typeof(T));
        public IEnumerable<IStepDescriptor<TReturn>> GetStepsForContextType(Type type) =>
