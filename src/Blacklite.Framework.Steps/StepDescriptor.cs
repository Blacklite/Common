...
namespace Blacklite.Framework.Steps
{
    ...
    class StepDescriptor<TReturn> : IStepDescriptor<TReturn>
    {
        ...
        ///  The execute method
        /// </summary>
        public Func<IServiceProvider, object, IStepContext, TReturn> ExecuteFunc { get; private set; }
        ...
        private static Func<IServiceProvider, object, IStepContext, TReturn> GetExecuteAction([NotNull] IStep step)
        {
            var typeInfo = step.GetType().GetTypeInfo();

            return typeInfo.CreateInjectableMethod("Execute")
